<template>
  <section class="outbound">
    ...
    <div class="img-contain">
      <div class="box-l">
        <div>
          <h2>巴厘岛奢华酒店下午茶之旅</h2><p>下午茶·巴厘岛</p>
        </div>
      </div>
      <div class="box-r"><div>清迈暹罗龙人妖秀·清迈</div></div>
    </div>
    <div class="outbound-ad"><img :src="ad" alt=""></div>
  </section>
</template>
...
<style scoped>
  ...
  .outbound .header{
    width: 100%;
    height: .5rem;
    background: url(../../../assets/images/cjcs.png) no-repeat;
